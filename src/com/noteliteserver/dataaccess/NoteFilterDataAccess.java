...
import com.notelitemodel.datatransfer.NoteFilter;
...
public class NoteFilterDataAccess implements BasicDataAccess<NoteFilter, NoteFilterKey, NoteKey> {
    ...
    public List<NoteFilter> getAll() throws DataAccessException {
        ...
        //Câu truy vấn SQL
        String query = "SELECT * FROM note_filters";
    ...
    @Override
    public void add(NoteFilter noteFilter) throws DataAccessException {
        throw new FailedExecuteException();
    }
    
    @Override
    public void add(NoteFilter noteFilter, NoteFilterKey key) throws DataAccessException {
        //Kiểm tra null
        if(connection == null) {
            throw new FailedExecuteException();
        }
